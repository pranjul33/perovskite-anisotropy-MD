...
| `lammps.nonbonding` | MYP force-field non-bonded parameters (`pair_coeff` lines: Buckingham for the inorganic Pb–I interactions, Lennard-Jones/charmm for the hybrid interactions). Included via `include dlpoly2lammps.nonbonding` in every LAMMPS input. |

Atom type mapping: 1 = Pb, 2 = I, 3 = H (attached to N), 4 = N, 5 = C, 6 = H (attached to C).
